...
public:
	...
	Dom(item item_, bool root_, const string & outfile_path_, const string& arg_, const string& str_, const string& dom_name_, size_t reserve_);
	~Dom();

	void set(item, const string&, const string&, const string&, size_t);
	void set(vector<string>, item, const string&, const string&, const string&, size_t);
